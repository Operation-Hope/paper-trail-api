"""Custom exception types for Voteview conversion errors with detailed context."""
...
@dataclass
class VoteviewConversionError(Exception):
    """Base exception for Voteview conversion errors."""
...
@dataclass
class CSVParseError(VoteviewConversionError):
...
@dataclass
class RowCountMismatchError(VoteviewConversionError):
...
@dataclass
class ChecksumMismatchError(VoteviewConversionError):
...
@dataclass
class SampleMismatchError(VoteviewConversionError):
...
@dataclass
class SchemaValidationError(VoteviewConversionError):
